...
import bg from "../../public/carnage.png";
...
export function BentoGridThirdDemo() {
  return (
    <BentoGrid className="max-w-full mx-20 md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          key={i}
          title={item.title}
...
const SkeletonOne = () => {
  ...
  return (
    <motion.div
      initial="initial"
      whileHover="animate"
      className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2 items-center"
    >
      <Image
        src={bg}
        alt="image not found :("
        className="bg w-full object-cover h-24 rounded-t-lg relative"
      />
      ...
      <Image
        ...
        width="70"
        height="70"
        className="z-10 absolute top-[170px] object-contain rounded-full object-center group-hover/card:shadow-xl p-1 ring-2 ring-white cursor-pointer"
        alt="image not found :("
      />
...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={first}
        className="h-full w-1/3 bg-transparent flex flex-col items-center justify-center shadow-card"
      >
        <PinContainer
          title="/ui.aceternity.com"
          href="https://twitter.com/mannupaaji"
        >
          <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-64 h-56">
      ...
      <motion.div className="h-full relative z-20 w-1/3 flex flex-col items-center justify-center shadow-card">
        <PinContainer
          title="/ui.aceternity.com"
          href="https://twitter.com/mannupaaji"
        >
      ...
      <motion.div
        variants={second}
        className="h-full w-1/3 flex flex-col items-center justify-center shadow-card"
      >
        <PinContainer
          title="/ui.aceternity.com"
          href="https://twitter.com/mannupaaji"
...
const SkeletonFive = () => {
  ...
  const cardClass =
    "rounded-xl hover:grow-[6] transition-grow flex items-center justify-center font-bold text-xl [&>*]:scale-75 md:[&>*]:scale-100";
  ...
  return (
    <motion.div
      ...
      className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2"
    >
      <div className={`grow flex flex-col container h-160 ${gapClass}`}>
        <div
          className={`grow-[1] flex flex-wrap items-stretch hover:grow-[1.5] transition-all duration-500 ${gapClass}`}
        >
          <a
            target="_blank"
            href=""
            ref={refs[3]}
            className={`${cardClass} bg-[#0077b5] w-16 grow`}
          >
            <svg
          ...
          <a
            ...
            href=""
            ref={refs[2]}
            className={`${cardClass} bg-[#1DBF73] w-16 grow-[4]`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
          ...
          <a
            ...
            href=""
            ref={refs[0]}
            className={`${cardClass} bg-[#222] w-16 grow`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
        ...
        <div
          className={`grow-[2] flex flex-wrap-reverse items-stretch hover:grow-[2.5] transition-all duration-500 ${gapClass}`}
        >
          <div className={`grow-[1] w-16 flex flex-col ${gapClass}`}>
            <a
              ...
              href=""
              ref={refs[4]}
              className={`${cardClass} bg-gradient-to-b from-green-400 to-green-500 grow`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
            ...
            <a
              ...
              href=""
              ref={refs[5]}
              className={`${cardClass} bg-gradient-to-r from-sky-400 to-blue-500 grow`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
              ...
              >
                <path
                  d="M54.25 31C54.25 26.142 52.7284 21.4061 49.8986 17.4574C47.0691 13.5086 43.0735 10.5454 38.4736 8.98388C33.8734 7.42233 28.8998 7.34096 24.2509 8.75115C19.6021 10.1613 15.5119 12.9922 12.5545 16.8463C9.59721 20.7004 7.92141 25.3839 7.76245 30.2392C7.6035 35.0946 8.96941 39.8779 11.6683 43.9169C14.3673 47.9562 18.2636 51.0487 22.8102 52.7599C27.3567 54.4711 32.3253 54.715 37.0176 53.4577"
                  stroke="currentColor"
                  strokeWidth="6"
                  strokeLinecap="round"
                />
                <path
                  d="M31 41.3333C36.7069 41.3333 41.3333 36.7069 41.3333 31C41.3333 25.293 36.7069 20.6666 31 20.6666C25.293 20.6666 20.6666 25.293 20.6666 31C20.6666 36.7069 25.293 41.3333 31 41.3333Z"
                  stroke="currentColor"
                  strokeWidth="6"
                />
                <path
                  d="M41.3334 23.25V34.875C41.3334 38.4418 44.2249 41.3333 47.7917 41.3333C51.3585 41.3333 54.25 38.4418 54.25 34.875V31"
                  stroke="currentColor"
                  strokeWidth="6"
                  strokeLinecap="round"
                />
          ...
          <a
            ...
            href=""
            ref={refs[1]}
            className={`${cardClass} bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-500 w-128 grow-[2]`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="35"
        ...
        >
          <a
            ...
            href=""
            ref={refs[9]}
            className={`${cardClass} bg-[#171717] text-[#13AFF0] w-16 grow`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
          ...
          <a
            ...
            href=""
            ref={refs[8]}
            className={`${cardClass} bg-[#1769FF] w-16 grow`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
          ...
          <a
            ...
            href=""
            ref={refs[7]}
            className={`${cardClass} bg-[#14171A] w-16 grow`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
          ...
          <a
            ...
            href=""
            ref={refs[6]}
            className={`${cardClass} bg-[#FF0000] w-16 grow`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
...
const items = [
...

  {
    ...
    header: <SkeletonFive />,
    className: "md:col-span-1",
    icon: <TbSocial className="h-4 w-4 text-neutral-500" />,
  },
];
