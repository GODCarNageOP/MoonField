        ...
        <div className="flex flex-col justify-between min-h-screen overflow-x-hidden">
            <div className={`grow flex flex-col container mx-auto h-160 ${gapClass} p-8`}>
                <div className={`grow-[1] flex flex-wrap items-stretch hover:grow-[1.5] transition-all duration-500 ${gapClass}`}>
                    <a target='_blank' href='' ref={refs[3]} className={`${cardClass} bg-[#0077b5] w-16 grow`}>
                    ...
                    <a target='_blank' href='' ref={refs[2]} className={`${cardClass} bg-[#1DBF73] w-16 grow-[4]`}>
                    ...
                    <a target='_blank' href='' ref={refs[0]} className={`${cardClass} bg-[#222] w-16 grow`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                ...
                <div className={`grow-[2] flex flex-wrap-reverse items-stretch hover:grow-[2.5] transition-all duration-500 ${gapClass}`}>
                    <div className={`grow-[1] w-16 flex flex-col ${gapClass}`}>
                        <a target='_blank' href='' ref={refs[4]} className={`${cardClass} bg-gradient-to-b from-green-400 to-green-500 grow`}>
                        ...
                        <a target='_blank' href='' ref={refs[5]} className={`${cardClass} bg-gradient-to-r from-sky-400 to-blue-500 grow`}>
                    ...
                    <a target='_blank' href='' ref={refs[1]} className={`${cardClass} bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-500 w-128 grow-[2]`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                ...
                <div className={`grow-[1] flex flex-wrap items-stretch hover:grow-[1.5] transition-all duration-500 ${gapClass}`}>
                    <a target='_blank' href='' ref={refs[9]} className={`${cardClass} bg-[#171717] text-[#13AFF0] w-16 grow`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    ...
                    <a target='_blank' href='' ref={refs[8]} className={`${cardClass} bg-[#1769FF] w-16 grow`}>
                    ...
                    <a target='_blank' href='' ref={refs[7]} className={`${cardClass} bg-[#14171A] w-16 grow`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    ...
                    <a target='_blank' href='' ref={refs[6]} className={`${cardClass} bg-[#FF0000] w-16 grow`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
